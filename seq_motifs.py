...
def get_motif_fig(filter_weights, filter_outs, out_dir, seqs, sample_i = 0):
    ...
    subprocess.call('/home/zhousc/meme-5.5.0/src/tomtom -dist pearson -thresh 0.05 -eps -oc %s/tomtom %s/filters_meme.txt %s' % (out_dir, out_dir, 'Ray2013_rbp_RNA.meme'), shell=True)
